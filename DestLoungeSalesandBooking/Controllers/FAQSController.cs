...
namespace DestLoungeSalesandBooking.Controllers
{
    public class FAQController : Controller
    {
        ...
        // GET: /FAQ/GetAllFAQs - Returns all active FAQs as JSON
        [HttpGet]
        ...
        // GET: /FAQ/GetFAQById/1 - Returns specific FAQ
        [HttpGet]
        public JsonResult GetFAQById(int id)
        {
            ...
            {
                var faq = db.tbl_faqs
                    .FirstOrDefault(f => f.faqID == id && f.isActive);
        ...
        // POST: /FAQ/UpdateFAQ/1 - Update existing FAQ
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult UpdateFAQ(int id, string question, string answer)
        {
            try
            {
                ...
                // Check if new question already exists (excluding current FAQ)
        ...
        // POST: /FAQ/DeleteFAQ/1 - Soft delete FAQ
        [HttpPost]
        [ValidateAntiForgeryToken]
